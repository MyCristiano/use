...
<div id="main">
  ...
  <div id="opt_area">
    ...
    <form action="../util/news_control.jsp?opr=modifyNews&nid=<%=news.getNid()%>"
    ...
    <h1 id="opt_type">
      ...
      <%} else {
	          ...
	          <td><a href="../util/news_control.jsp?opr=deleteComment&cid=<%=comment.getCid()%>&nid=<%=news.getNid()%>">删除</a></td>
	        </tr>
	        <tr>
